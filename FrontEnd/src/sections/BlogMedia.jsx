    ...
    <div className="text-[#20172A]">
      ...
      <a href={blogMedia.moreHref}>
        <div className="relative flex justify-center mt-3 md:mt-6 overflow-hidden">
          <button
            aria-busy="false"
            className="flex font-semibold items-center justify-center w-[132px] h-[44px] gap-[10px] rounded-[12px] text-white duration-500 transition-colors ease-in-out disabled:cursor-not-allowed disabled:opacity-70 bg-[#20172A]"
