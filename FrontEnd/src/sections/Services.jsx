  ...
  return (
    <section>
      ...
      {canShowMore && (
        <button
          type="button"
          className="mx-auto flex items-center justify-center gap-2 px-4 py-[10px] h-10 rounded-full bg-[#20172A] text-white hover:bg-[#3A294F] hover:shadow-[0_8px_18px_rgba(101,55,166,0.22)] hover:-translate-y-px text-sm font-semibold transition-all duration-250 cursor-pointer border-0 shadow-[0_1px_1px_rgba(32,23,42,0.08)]"
